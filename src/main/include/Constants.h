...
#define WHEEL_DIAMETER 0.10033
    ...
    #define FRONT_LEFT_MODULE_STEER_OFFSET 0//-204.9//-204.7//-183.2//-203.6 //-207.8//JJ-180 //-198.2 //-207.8
    #define FRONT_LEFT_MODULE_ENCODER_PORT 2

    #define FRONT_RIGHT_MODULE_DRIVE_MOTOR 38
    #define FRONT_RIGHT_MODULE_STEER_MOTOR 61
    #define FRONT_RIGHT_MODULE_STEER_OFFSET 0//-182.8//-181.2//-180.1//-181.9 //-178.47//JJ-179 //-180.97 //-178.47
    #define FRONT_RIGHT_MODULE_ENCODER_PORT 1

    #define BACK_LEFT_MODULE_DRIVE_MOTOR 32
    #define BACK_LEFT_MODULE_STEER_MOTOR 35
    #define BACK_LEFT_MODULE_STEER_OFFSET 0//-208.4//-146.9//-238.0//-146.9//-200.9//-164.0 //-161.51//-178.25// -180.43
    #define BACK_LEFT_MODULE_ENCODER_PORT 3

    #define BACK_RIGHT_MODULE_DRIVE_MOTOR 51
    #define BACK_RIGHT_MODULE_STEER_MOTOR 60
    #define BACK_RIGHT_MODULE_STEER_OFFSET 0//-293.4//-299.3//-176.5//-297.6 //-296.93//JJ-359//-294.17 //-296.93
    #define BACK_RIGHT_MODULE_ENCODER_PORT 0
